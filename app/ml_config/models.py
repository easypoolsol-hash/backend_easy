...
class BackendModelConfiguration(models.Model):
    ...
    # =============================================================================
    mobilefacenet_threshold = models.FloatField(
        default=0.50,
    ...
    adaface_threshold = models.FloatField(
        default=0.40,
    ...
    def create_default_config(cls):
        """Create default configuration matching current ml_models/config.py"""
        config = cls.objects.create(
            name="Default Production Config",
            description="Initial configuration matching ml_models/config.py baseline",
            is_active=True,
            # Weights
