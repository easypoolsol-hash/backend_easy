...
class BusModelTest(TestCase):
    ...
    def test_bus_utilization(self):
        ...
        bus = Bus.objects.create(license_plate="XYZ-789", capacity=10)
...
class RouteAPITest(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="admin", email="admin@example.com", password="admin123", role=role
        )
    ...
    def test_create_route(self):
        ...
        data = {
            ...
            "schedule": {"morning": {"start": "08:00", "end": "09:00"}},
        }
